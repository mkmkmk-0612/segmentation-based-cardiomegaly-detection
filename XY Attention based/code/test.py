...
RESTORE_LUNG_FROM = dir_prefix + 'models/'
RESTORE_CENTER_FROM = dir_prefix + 'models/'
...
def get_arguments():
    ...
    parser.add_argument("--restore-lung-from", type=str, default=RESTORE_LUNG_FROM,
                        help="Where restore model parameters from.")
    parser.add_argument("--restore-center-from", type=str, default=RESTORE_CENTER_FROM,
                        help="Where restore model parameters from.")
...
def main():
    ...
    saved_state_dict = torch.load(args.restore_lung_from)
...
def main_2():
    ...
    saved_state_dict = torch.load(args.restore_center_from)
    model.load_state_dict(saved_state_dict)
